...
Original file is located at
    https://colab.research.google.com/drive/1Y-VddzBd-Zlurjued5ahDaUpddVkiAbh
"""
...
def dh(f, h, x):
    ...
    return (f(x+h)-f(x-h))/(2*h) # delete this line
def dh1(f, h, x):
...
def error(f, hs, x_i):
    ...
    for h in hs:
        ...
        diff_error[i]=Y_actual-dh(f,h,x_i);
        diff2_error[i]=Y_actual-dh1(f,h,x_i);
        i+=1;
         # delete this line
